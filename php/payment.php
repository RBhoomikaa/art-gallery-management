      ...
      <form action="/action_page.php">
        ...
        <div class="row">
          <div class="col-50">
            ...
            <div class="row">
              ...
              <div class="col-50">
                ...
                <input type="text" id="pin" name="pin" placeholder="10001">
              </div>
            </div>
          </div>
          ...
          <div class="col-50">
            <h3>Payment</h3>
<label>
          <input type="checkbox" checked="checked" name="sameadr"> COD
        </label>
            ...
            <input type="checkbox" checked="checked" name="sameadr"> DEBIT CARD
          <input type="text" id="cname" name="cardname" placeholder="Enter your name as in your card">
...
<label>
    ...
    <p><a href="cart.php">NEXT</a></p></label>
    </div>
  </div>
</div>
